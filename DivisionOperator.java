...
public class DivisionOperator implements Operator, Expression {
	...
	public int evaluate(Robot robot, Map<Variable, Expression> variables) {
		...
		if (argOneValue == null) {
			//System.out.println("Div: arg1 null");
		}
		if (argTwoValue == null) {
			//System.out.println("Div: arg2 null");
		}
	...
	public boolean parse(Scanner s) {
		//System.out.println("DivisionOperator: Parse");
		//System.out.println("DivisionOperator Next: " + s.next());
		s.next();

		while (argumentOne == null || argumentTwo == null) {
			//System.out.println("DivisionOperator: Loop");

			if (!s.hasNext("-?[1-9][0-9]*|0|fuelLeft|oppLR|oppFB|numBarrels|barrelLR|barrelFB|wallDist|add|mul|div|sub")) {
				//System.out.println("DivisionOperator Loop Next: " + s.next());
				s.next();
			}

			// TODO: DIVISION/MUL/ADD/SUB need to check

			// Numbers
			if (s.hasNext("-?[1-9][0-9]*|0")) {
				//System.out.println("DivisionOperator: Number");

				if (argumentOne == null) {
					argumentOne = new Number(s.nextInt());
					if(!s.hasNext("\\,|\\)|\\(")){
						Parser.fail("Expected , next", s);
					}
			...
			if (s.hasNext("fuelLeft")) {
				//System.out.println("DivisionOperator: fuelLeft");
				//System.out.println("DivisionOperator Next: " + s.next());
				s.next();
			...
			if (s.hasNext("oppLR")) {
				//System.out.println("DivisionOperator: oppLR");
				//System.out.println("DivisionOperator Next: " + s.next());
				s.next();
			...
			if (s.hasNext("oppFB")) {
				//System.out.println("DivisionOperator: oppFB");
				//System.out.println("DivisionOperator Next: " + s.next());
				s.next();
			...
			if (s.hasNext("numBarrels")) {
				//System.out.println("DivisionOperator: numBarrels");
				//System.out.println("DivisionOperator Next: " + s.next());
				s.next();
			...
			if (s.hasNext("barrelLR")) {
				//System.out.println("DivisionOperator: barrelLR");
				//System.out.println("DivisionOperator Next: " + s.next());
				s.next();
			...
			if (s.hasNext("wallDist")) {
				//System.out.println("DivisionOperator: wallDist");
				//System.out.println("DivisionOperator Next: " + s.next());
				s.next();
			...
			// Operators
			if (s.hasNext("add")) {
				//System.out.println("DivisionOperator: Operator Add");
				//System.out.println("DivisionOperator Next: " + s.next());
				s.next();
			...
			if (s.hasNext("sub")) {
				//System.out.println("DivisionOperator: Operator Subtraction");
				//System.out.println("DivisionOperator Next: " + s.next());
				s.next();
			...
			if (s.hasNext("mul")) {
				//System.out.println("DivisionOperator: Operator Multiplication");
				//System.out.println("DivisionOperator Next: " + s.next());
				s.next();
			...
			if (s.hasNext("div")) {
				//System.out.println("DivisionOperator: Operator Division");
				//System.out.println("DivisionOperator Next: " + s.next());
				s.next();
			...
			if (s.hasNext("\\$[A-Za-z][A-Za-z0-9]*")) {
				//System.out.println("DivisionOperator: Assignment");
				//System.out.println("DivisionOperator Next: " + s.next());
				s.next();
		...
		if (argumentOne != null && argumentTwo != null) {
			//System.out.println("DivisionOperator: Expression was not null. RETURNING TRUE.");
			return true;
		}

		//System.out.println("DivisionOperator: All were null. RETURNING FALSE.");
		Parser.fail("Division Operator failed. Argument 1 or 2 was null.", s);
		return false;
	}

	public String toString() {
		return "div(" + argumentOne.toString() + "," + argumentTwo.toString()+ ")";
	}
